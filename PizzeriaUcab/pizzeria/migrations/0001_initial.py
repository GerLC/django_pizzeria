    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('monto_bebida', models.DecimalField(decimal_places=16, max_digits=18)),
            ],
        ),
        migrations.CreateModel(
            name='Pedido',
            fields=[
                ...
                ('total_pedido', models.DecimalField(decimal_places=3, max_digits=18)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('monto_tamano', models.DecimalField(decimal_places=16, max_digits=18)),
            ],
        ),
        migrations.CreateModel(
            name='Toppin',
            fields=[
                ...
                ('monto_toppin', models.DecimalField(decimal_places=16, max_digits=18)),
            ],
        ),
        migrations.CreateModel(
            name='PizzaToppin',
